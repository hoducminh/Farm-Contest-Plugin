...
public class FarmContest extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        // Check version compatibility immediately on startup (1.20 → 1.21.11+)
        ServerVersion.logCompat(getLogger(), 1, 20);
        ...
        getServer().getPluginManager().registerEvents(
                new FarmListener(this, contestManager, configManager), this);
        getServer().getPluginManager().registerEvents(
                new MobListener(this, contestManager, configManager), this);
        getServer().getPluginManager().registerEvents(
